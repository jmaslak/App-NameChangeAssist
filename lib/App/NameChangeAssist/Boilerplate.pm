...
package App::NameChangeAssist::Boilerplate;
# ABSTRACT: Default Boilerplate for App::NameChangeAssist
...
the C<App::NameChangeAssist> distribution, it is probably best
to fetch C<JTM::Boilerplate> and copy the C<Boilerplate.pm> into some
